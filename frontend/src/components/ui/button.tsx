...
const buttonVariants = cva(
  // transition-colors, not transition-all -- only bg/text/border-color
  // actually change here (hover, variant, disabled); "all" left them
  // riding Tailwind's generic default instead of failing to animate
  // anything in particular, but it's still the wrong property list.
